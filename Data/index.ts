...
export const caseStudies = [
  ...
  {
    id: 3,
    title: "Análise de Atendentes",
    description:
      "Painel para acompanhar desempenho dos atendentes, recorrência de falhas, origem dos casos e rastreabilidade por responsável.",
    category: "Atendimento, qualidade & BI",
    icon: "🎧",
    previewImage: "/cases/analise-atendentes.svg",
    previewAlt: "Preview anonimizado do dashboard Análise de Atendentes",
    features: ["Power BI", "DAX", "Power Query", "Deneb", "HTML Content", "Slicers"],
    impact: "Ajuda a identificar concentração de casos, origem das falhas e responsáveis com maior recorrência para orientar ação corretiva.",
    flow: ["Casos", "Tratamento", "Modelo", "Ranking", "Ação"],
    proofPoints: ["3 páginas", "65 visuais", "25 Deneb", "10 HTML Content", "15 slicers"],
    buildDetails: [
      "Modelagem orientada a casos, atendentes, origem da falha, período, regional e indicadores de rastreabilidade.",
      "Medidas DAX para total de casos, média por atendente, maior taxa de recorrência, participação por origem e último caso.",
      "Deneb e HTML Content usados para ranking, cards, rosca, tendência mensal e tabela detalhada em layout executivo.",
      "Preview publicado com nomes e números sintéticos para preservar o layout sem expor dados internos.",
    ],
    iframeSrc: "",
  },
  {
